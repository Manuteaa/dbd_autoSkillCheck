...
if sys.platform == "win32":
    ...
    class KEYBDINPUT(ctypes.Structure):
        ...
        def __init__(self, *args, **kwds):
            ...
            # Some programs use the scan code even when KEYEVENTF_SCANCODE is not set.
    ...
    def PressKey(key):
        _get_keyboard_controller().press(key)

    def ReleaseKey(key):
        _get_keyboard_controller().release(key)
    ...
    def _unsupported_platform():
        msg = f"Keyboard input is not supported on {sys.platform}."
